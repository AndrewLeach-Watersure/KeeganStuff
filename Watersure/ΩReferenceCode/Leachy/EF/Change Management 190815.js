Ext.define('EAM.custom.external_UUCHV3', {
  ...
  getSelectors: function() {
    return {
      /* This block of code is used to stop the work order from being able to be changed as it is a dumb field, i couldn't get the onrender to work so it is a "focus" which means when you click on it */
      ...
      '[extensibleFramework] [tabName=HDR][isTabView=true] [name=wspf_10_cmf_reqbrief]': {
        blur: function(field, lastValues) {
          ...
          var vFormPanel = EAM.Utils.getCurrentTab().getFormPanel(),
            ...
            vFlag = !(((vStatus === 'Change Request') ? true : false) || ((vUser === 'R5') ? true : false)),
            ...
            wspf_10_cmf_execsummary = vFormPanel.getFldValue('wspf_10_cmf_execsummary'),
          ...
          EAM.Utils.debugMessage(wspf_10_cmf_tempmodchbx); /* Debug messages for troubleshooting*/
                ...
                },
                {
                  ...
                  items: [
                  {
                    ...
                    },
                     {
                      ...
                      emptyText: 'In bullet points describe the problem this project aims to solve, or the opportunity it aims to develop and implement. Why is it needed?',
                      /* This is the text thats shown when its empty, i use to explain the field a little*/
                      value: wspf_10_cmf_need,
                      name: 'vwspf_10_cmf_need'
                    },
                    {
                      fieldLabel: '<b>What</b><br> <em>Details of scope</em>',
                      emptyText: 'Include current situation, what project involves – short summary, include any staffing and equipment/technology requirements. What other options are there?',
                      value: wspf_10_cmf_aims,
                      name: 'vwspf_10_cmf_aims'
                    },
                    {
                      fieldLabel: '<b>What</b><br> <em>Benefits and risks</em>',
                      emptyText: 'List in bullet point form, the expected benefits as a result of completing project, any risks to the business of not completing project. Any benefits in not carrying out the project or risks in carrying out the project?',
                      value: wspf_10_cmf_roi,
                      name: 'vwspf_10_cmf_roi'
                    },
                    {
                      fieldLabel: '<em>Financial Cost Benefit analysis</em>',
                      emptyText:'Brief overview - costs of carrying out project (including resources such as staffing and materials), any potential longer term business costs of not carrying out project. Potential savings to company by doing the project.',
                      value: wspf_10_cmf_indschedres,
                      name: 'vwspf_10_cmf_indschedres'
                    },
                    {
                      fieldLabel: '<b>Who</b><br> <em>Stakeholders</em>',
                      emptyText: 'Who will be involved in developing and implementing this project at Watersure? Who may be impacted? Who needs to be aware that works are proposed?',
                      value: wspf_10_cmf_stakeholders,
                      name: 'vwspf_10_cmf_stakeholders'
                    },
                    {
                      fieldLabel: '<b>When</b><br> <em>Measurement of success</em>',
                      emptyText: 'How will you know the project has been successful, how will you measure this?',
                ...
                },
                {
                  ...
                  items: [{
                    ...
                    },
                    {
                      ...
                      emptyText: '(RSK-000-FM-001  Revision 3.0 Risk Assessment Form)<br>Risk of <b>not</b> doing the project',
            ...
            buttons: [{
              ...
              handler: function(btn) {
                var win = btn.up('window'),
                  ...
                  vDirty = false;
                  vFormPanel.setFldValue('wspf_10_cmf_car', values.vwspf_10_cmf_car, true), /*sets the values for the original screen 'vformpanel' sets the fields value (field name, value from the popup, true) */
                  vFormPanel.setFldValue('wspf_10_cmf_execsummary', values.vwspf_10_cmf_execsummary, true),
                  ...
                  vFormPanel.getForm().findField("wspf_10_cmf_tempmodchbx").setValue(form.getForm().findField("vwspf_10_cmf_tempmodchbx").getValue()), /*This is the weird shit i had to do to get the checkboxes working */
                ...
                form.getForm().isDirty() == true ? 
                (document.getElementsByName('wspf_10_cmf_updatedby')[0].value = vUser,
                document.getElementsByName('wspf_10_cmf_updatedby')[0].select()) : null;
                win.close();
              }
            }]
          }).show();
      ...
      '[extensibleFramework] [tabName=HDR][isTabView=true] [name=wspf_10_cmf_chappr]': {
        blur: function(field, lastValues) {
          var vFormPanel = EAM.Utils.getCurrentTab().getFormPanel(),
            ...
            wspf_10_cmf_priority = vFormPanel.getFldValue('wspf_10_cmf_priority'),
            ...
            wspf_10_cmf_eicommcheck = vFormPanel.getFldValue('wspf_10_cmf_eicommcheck'),
            wspf_10_cmf_mechcommcheck = vFormPanel.getFldValue('wspf_10_cmf_mechcommcheck'),
            wspf_10_cmf_plantcommcheck = vFormPanel.getFldValue('wspf_10_cmf_plantcommcheck'),
            wspf_10_cmf_safecommcheck = vFormPanel.getFldValue('wspf_10_cmf_safecommcheck'),
            ...
            wspf_10_cmf_reviewdue = vFormPanel.getFldValue('wspf_10_cmf_reviewdue'),
            wspf_10_cmf_rejected = vFormPanel.getForm().findField("wspf_10_cmf_rejected").getValue();
            ...
            items: [{
              ...
              items: [{
                  ...
                  defaults: {
                    ...
                    labelStyle: 'font-weight:bold;',
                    xtype: 'textareafield',
                    emptyText: 'Enter caveats/concerns/comments here, you may also just leave "Approved" or similar to indicate your approval \n Use N/A if not applicable to your discipline etc',
                  },
                  items: [{
                      fieldLabel: 'Senior Electrical Engineer\nApproval Comments',
                      value: wspf_10_cmf_eicomm,
                      emptyText: (wspf_10_cmf_rejected === true) ? 'Enter caveats/concerns/comments here, you may also just leave "Approved" or similar to indicate your approval \n Use N/A if not applicable to your discipline etc' : wspf_10_cmf_eicommcheck,
                    ...
                    },
                    {
                      ...
                      emptyText: (wspf_10_cmf_rejected === true) ? 'Enter caveats/concerns/comments here, you may also just leave "Approved" or similar to indicate your approval \n Use N/A if not applicable to your discipline etc' : wspf_10_cmf_mechcommcheck,
                    ...
                    },
                    {
                      ...
                      emptyText: (wspf_10_cmf_rejected === true) ? 'Enter caveats/concerns/comments here, you may also just leave "Approved" or similar to indicate your approval \n Use N/A if not applicable to your discipline etc' : wspf_10_cmf_plantcommcheck,
                ...
                },
                {
                  ...
                  items: [{
                      ...
                      queryMode: 'local',
                      store: ['ENG', 'EI', 'ICT', 'MECH', 'OPS', 'PLANTOPS', 'PROJ', 'PRO', 'SITEOPS'],
                      value: wspf_10_cmf_owner,
                      name: 'vwspf_10_cmf_owner',
                      readOnly: !((vUser === "SBAHUTH") ? true : false || (vUser === "R5") ? true : false || (vUser === "JTAUVRY") ? true : false),
                    },
                    {
                      xtype: 'combo',
                      fieldLabel: 'Project Lead',
                      queryMode: 'local',
                      store: ['BLEE', 'BPAGE', 'CREID', 'CRODRIGUEZ', 'DCHENEY', 'DFRISWELL', 'DHOEDT', 'GMERCER', 'JREID', 'JTAUVRY', 'KHARRIS', 'LBURCHER', 'LWATKINS', 'MLAGUITTON', 'MLANE', 'PRAYNER', 'RKOCH', 'SBAHUTH', 'SIVANOVIC', 'SSLATTERY', 'EPRADEL', 'JKUYPER', 'BFORSYTH'],
                      value: wspf_10_cmf_collab,
                      name: 'vwspf_10_cmf_collab',
                      readOnly: !((vUser === wspf_10_cmf_owner) ? true : false || (vUser === "R5") ? true : false || (vUser === "JTAUVRY") ? true : false || (vUser === "SBAHUTH") ? true : false),
                    },
                    {
                      xtype: 'datefield',
                    ...
                    },
                    {
                      ...
                      queryMode: 'local',
                      store: ['1. Start engineering investigation', '2. Proceed to Concept', '3. Proceed to implementation (Perm. Mod.)', '4. Proceed to implementation (Temp. Mod.)', '5. Cancel', '6. Reject'],
                      autoSelect: true,
                      forceSelection: true,
                      readOnly: !((vUser === "SBAHUTH") ? true : false || (vUser === "R5") ? true : false || (vUser === "JTAUVRY") ? true : false),
                    }
            ...
            buttons: [{
              ...
              handler: function(btn) {
                var win = btn.up('window'),
                  ...
                  vDirty = false,
                  values = form.getValues();
                  vFormPanel.setFldValue('wspf_10_cmf_eicommcheck', values.vwspf_10_cmf_eicomm, true),
                  vFormPanel.getForm().findField("wspf_10_cmf_reviewdue").setValue(form.getForm().findField("vwspf_10_cmf_reviewdue").getValue()),
                 // vFormPanel.setFldValue('wspf_10_cmf_reviewdue', Ext.Date.format(values.vwspf_10_cmf_reviewdue, 'd/M/Y'), true),
                  vFormPanel.setFldValue('wspf_10_cmf_mechcommcheck', values.vwspf_10_cmf_mechcomm, true),
                  vFormPanel.setFldValue('wspf_10_cmf_priority', values.vwspf_10_cmf_priority, true),
                  vFormPanel.setFldValue('wspf_10_cmf_plantcommcheck', values.vwspf_10_cmf_plantcomm, true),
                  vFormPanel.setFldValue('wspf_10_cmf_safecommcheck', values.vwspf_10_cmf_safecomm, true),
                  ...
                  vFormPanel.setFldValue('wspf_10_cmf_collab', values.vwspf_10_cmf_collab, true),
      ...
      '[extensibleFramework] [tabName=HDR][isTabView=true] [name=wspf_10_cmf_concdet]': {
        blur: function(field, lastValues) {
          var vFormPanel = EAM.Utils.getCurrentTab().getFormPanel(),
            ...
            vFlag = !((((vUser === vOwner) ? true : false || (vUser === vCollab) ? true : false) && ((vStatus === 'Concept')) ? true : false) || ((vUser === 'R5') ? true : false)),
      ...
      '[extensibleFramework] [tabName=HDR][isTabView=true] [name=wspf_10_cmf_concappr]': {
        blur: function(field, lastValues) {
          var vFormPanel = EAM.Utils.getCurrentTab().getFormPanel(),
            ...
            vOwner = vFormPanel.getFldValue('wspf_10_cmf_owner'),
            vStatus = vFormPanel.getFldValue('wspf_10_cmf_status'),
            vFlag = !((vStatus == 'Concept Review (3 Pillars)') ? true : false || (vStatus == 'Concept Approval (Manager)') ? true : false), // (vStatus === "Change Request") ? false : true,
            ...
            items: [{
              ...
              items: [{
                ...
                items: [{
                    ...
                    emptyText: 'Enter caveats/concerns/comments here, you may also just leave "Approved" or similar to indicate your approval \n Use N/A if not applicable to your discipline etc',
                    editable: (vUser === vOwner) ? true : false || (vUser === "R5") ? true : false || (vUser === vCollab) ? true : false,
                  },
                  {
                    fieldLabel: 'Senior Electrical Engineer\nApproval Comments',
      ...
      '[extensibleFramework] [tabName=HDR][isTabView=true] [name=wspf_10_cmf_detaildesign]': {
        blur: function(field, lastValues) {
          var vFormPanel = EAM.Utils.getCurrentTab().getFormPanel(),
            ...
            vStatus = vFormPanel.getFldValue('wspf_10_cmf_status'),
            vCollab = vFormPanel.getFldValue('wspf_10_cmf_collab'),
            vFlag = !((((vUser === vOwner) ? true : false || (vUser === vCollab) ? true : false) && ((vStatus === 'Detail Design')) ? true : false) || ((vUser === 'R5') ? true : false)),
      ...
      '[extensibleFramework] [tabName=HDR][isTabView=true] [name=wspf_10_cmf_impdetail]': {
        blur: function(field, lastValues) {
          var vFormPanel = EAM.Utils.getCurrentTab().getFormPanel(),
            ...
            vStatus = vFormPanel.getFldValue('wspf_10_cmf_status'),
            vCollab = vFormPanel.getFldValue('wspf_10_cmf_collab'),
            vFlag = !((((vUser === vOwner) ? true : false || (vUser === vCollab) ? true : false) && ((vStatus === 'Implementation')) ? true : false) || ((vUser === 'R5') ? true : false)),
